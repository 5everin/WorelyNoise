...
'Every pixel needs to be checked against every seed point to find the lowest n distances. (In this program the maximum n value is 3)
...
Public Class Form1
    ...
    Public Sub Gen()
        'step through each pixel in the picbox (displayarray) and find the nearest 3 seed points
        ...
        Parallel.For(0, displayArray.Length, Sub(pixelnumber As Int32)
                                                 ...
                                                 Dim lowval As Single = 999999999
                                                 Dim lowval2 As Single = 999999999
                                                 Dim lowval3 As Single = 999999999
                                                 Dim dist As Single
                                                 For seednumber As Int32 = 0 To maxseeds - 1
                                                     ...
                                                     If dist <= lowval Then
                                                         ...
                                                         lowval2 = lowval
                                                         lowval = dist
                                                     ElseIf dist <= lowval2 Then
                                                         lowval3 = lowval2 : lowval2 = dist
                                                     ElseIf dist <= lowval3 Then
                                                         lowval3 = dist
                                                     End If
                                                 Next
                                                 'Make some colour frome the noise value
                                                 Dim col As Int32
                                                 If CheckBox2.Checked = True Then 'alternate noise fromula..looks like chunks of ice or rock
                                                     col = Abs(CInt(lowval - lowval2) + CInt(lowval - lowval3))
                                                 Else
                                                     If nval = 1 Then
                                                         col = CInt(lowval)
                                                     ElseIf nval = 2 Then
                                                 ...
                                                 If CheckBox1.Checked = True Then
                                                     displayArray(pixelnumber) = (255 << 24) + ((col) << 16) + ((col) << 8) + (col + 140 - CInt(lowval2 - lowval) >> 1) 'some colour
                                                 Else
    ...
    Private Sub CheckBox2_CheckedChanged(sender As Object, e As EventArgs) Handles CheckBox2.CheckedChanged
        NumericUpDown1.Enabled = Not CheckBox2.Checked
    End Sub
End Class
