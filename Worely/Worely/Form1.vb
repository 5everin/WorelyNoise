        ...
        Parallel.For(0, displayArray.Length, Sub(pixelnumber As Int32)
                                                 ...
                                                 For seednumber As Int32 = 0 To maxseeds - 1
                                                     ...
                                                     If dist <= lowval Then
                                                         lowval2 = lowval
                                                         lowval = dist
                                                     ElseIf dist <= lowval2 And dist <= lowval3 Then
                                                         lowval3 = lowval2 : lowval2 = dist
                                                     Else
                                                         If dist < lowval3 Then lowval3 = dist
                                                     End If
                                                 Next
                                                 ...
                                                 '      col = Abs(CInt(lowval - lowval2) + CInt(lowval - lowval3))  'alternate noise fromula..looks like chunks of ice
